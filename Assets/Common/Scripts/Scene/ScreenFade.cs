...
public class ScreenFade : MonoBehaviour
{
	...
	// Events triggered during the fade
	public event System.Action OnFadeComplete;    // Called when fade completes
	public event System.Action<float> OnFadeProgress;    // Called with progress value (0-1) during fade
